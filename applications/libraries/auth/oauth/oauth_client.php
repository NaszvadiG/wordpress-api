	...
	<variable>
		...
		<documentation>
			...
			<usage>The class provides built-in support to several types of OAuth
				...
				<stringvalue>Youtube</stringvalue>,
...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'Google':
				$this->oauth_version = '2.0';
				$this->dialog_url = 'https://accounts.google.com/o/oauth2/auth?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}&access_type=offline&approval_prompt=force';//'https://accounts.google.com/o/oauth2/auth?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
